...
long dmsoft::AiYoloSetVersion(const TCHAR * Ver)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long dmsoft::AiYoloSetModelMemory(long index,long addr,long size,const TCHAR * pwd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long dmsoft::LoadAi(const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString dmsoft::AiYoloObjectsToString(const TCHAR * objects)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long dmsoft::AiYoloSetModel(long index,const TCHAR * file_name,const TCHAR * pwd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long dmsoft::AiYoloDetectObjectsToFile(long x1,long y1,long x2,long y2,float prob,float iou,const TCHAR * file_name,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString dmsoft::AiYoloSortsObjects(const TCHAR * objects,long height)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
